  ...
  <body>
    <div id="flex-container">
      ...
      <nav class="pb-3" id="desktop-nav">
        ...
        >
          <a class="aesthetnova" href="index.php">Home</a>
          <a class="aesthetnova" href="recipes.php">Recipes</a>
          <a class="aesthetnova" href="about-contact.php#about">About Us</a>
          <a class="aesthetnova" href="about-contact.php#contact"
            >Contact Us</a
          >
          <a class="aesthetnova" href="login.php"
      ...
      >
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="about-contact.php#about">About Us</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="about-contact.php#contact"
                >Contact Us</a
              >
            </li>
            <li class="nav-item">
