...
//Plug in extensions found in the fullpage folder
const pluginWrapper = () => {
  require("./fullpage/fullpage.scrollHorizontally.min");
  require("./fullpage/fullpage.dragAndMove.min");
  require("./fullpage/fullpage.resetSliders.min");
  require("./fullpage/fullpage.scrollOverflowReset.min");
};
//Initialize fullpage
const Fullpage = function loadFullPage() {
  ...
  function fakeRequest() {
    //Simulates a request; makes a "promise" that'll run for 500 milliseconds
      ...
      <ReactFullpage
        ...
        afterLoad={function (origin, destination, direction) {
          ...
          if (activeSection.anchor === "s1") {
            gsap
              .timeline()
              .to("#header", { delay: 4, duration: 1, opacity: 1 })
